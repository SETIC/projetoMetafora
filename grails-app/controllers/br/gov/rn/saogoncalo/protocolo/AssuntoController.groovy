		...
		if((session["user"] == null) || (session["pass"] == null) ){
			...
			if (perm1 || perm2) {
				...
				if (session["escid"] == 0) {
					...
					assunto = Assunto.findAllByPessoaJuridica(pessoaJuridica)
	...
	def salvar(){
		...
		if((session["user"] == null) || (session["pass"] == null) ){
			...
			if (perm2) {
				...
				assunto.pessoaJuridica = PessoaJuridica.get(session["escid"])
	...
	def listarMensagem(String msg, String tipo){
		...
		if((session["user"] == null) || (session["pass"] == null) ){
			...
			if (perm1 || perm2) {
				...
				def pessoaJuridica = PessoaJuridica.get(session["escid"])
				def assunto = Assunto.findAllByPessoaJuridica(pessoaJuridica)
