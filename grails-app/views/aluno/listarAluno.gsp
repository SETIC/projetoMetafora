	...
	<section class="content">
		<div>
			...
			<div class="modal fade" id="myModal" tabindex="-1" role="dialog"
				aria-labelledby="myModalLabel" aria-hidden="true" onload="ocultarMensagemDeErro();">
								    ...
								    <div class="" style="margin-top: ; margin-bottom: 0px;">
								            ...
								            <div class="step">
								                ...
								                <div id="div3" class="col-md-4 mouse-point" onclick="javascript: resetActive(div3, event, 70, 'step-3');">
								                    <div class="row">
								                        ...
								                        <p>Dados Variáveis <br/>(iníco do ano corrente)</p>
								                    </div>
								                </div>
								        ...
								        <div class="activeStepInfo" id="step-1" style="margin-top: 2%;">
								            <h3>Identificação</h3>
								              ...
								              <div class="form-group">
								                <label for="iDataDeNascimento" class="col-sm-2 control-label">Data de Nascimento</label>
								                <div class="col-sm-10">
								              ...
								              <div class="form-group">
								                ...
								                <div class="col-sm-10">
								                  <g:textField class="form-control" id="iNomeDoPai" name="nomeDoPai" placeholder="Nome do Pai" required="true"/>
								                </div>
								              </div>
								              <div class="form-group">
								                <label for="iNomeDaMae" class="col-sm-2 control-label">Nome da Mãe</label>
								                <div class="col-sm-10">
								                  <g:textField class="form-control" id="iNomeDaMae" name="nomeDaMae" placeholder="Nome da Mãe" required="true"/>
								                </div>
								              </div>
								              <div class="form-group">
								        ...
								        <div class="hiddenStepInfo" id="step-2" style="margin-top: 2%;">
								            <h3>Endereço</h3>
								              <div class="form-group">
								                <label class="col-sm-2 control-label">Localização/Zona de residência</label>
								                <div class="col-sm-10 radio" style="padding-top: 0px;">
								                  <label for="iLocalizacaoUrbana" class="radio-inline">
								                    <input type="radio" name="localizacao" id="iLocalizacaoUrbana" value="URBANA" checked> Urbana
								                  </label>
								                  <label for="iLocalizacaoRural" class="radio-inline">
								                    <input type="radio" name="localizacao" id="iLocalizacaoRural" value="RURAL"> Rural
								                  </label>
								                </div>
								              </div>
								              <div class="form-group">
								                ...
								                <div id="iDivInputCep" class="col-sm-10">
								                  <g:textField type="number" class="form-control" data-mask="99999-999" name="cep" id="iCep" onfocusout="javascript: requestAjax(this);" placeholder="CEP"/>
								                  <p id="iMensagemCEP" class="text-danger">Por favor digite um CEP válido.</p>
								                </div>
								              </div>
								              <div class="form-group">
								              ...
								              <div class="form-group">
								                ...
								                <div class="col-sm-10">
								                  <input type="number" class="form-control" name="numero" id="iNumero" placeholder="Número">
								                </div>
								              </div>
								              <div class="form-group">
								                <label for="iComplemento" class="col-sm-2 control-label">Complemento</label>
								                <div class="col-sm-10">
								                  <input type="text" class="form-control" name="complemento" id="iComplemento" placeholder="Complemento">
								                </div>
								              </div>
								              <div class="form-group">
								                <label for="iBairro" class="col-sm-2 control-label">Bairro</label>
								                <div class="col-sm-10">
								                  <input type="text" class="form-control" name="bairro" id="iBairro" placeholder="Bairro">
								                </div>
								              </div>
								              <div class="form-group">
								                <label for="iUf" class="col-sm-2 control-label">UF</label>
								                <div class="col-sm-10">
								                  <input type="text" class="form-control" name="uf" id="iUf" placeholder="Estado">	
								                </div>
								              </div>
								              <div class="form-group">
								                <label for="iMunicipio" class="col-sm-2 control-label">Município</label>
								                <div class="col-sm-10">
								                  <input type="text" class="form-control" name="municipio" id="iMunicipio" placeholder="Município">
								                </div>
								              </div>
								              <div class="form-group" style="margin-top: 3%;">
								                <div class="col-sm-offset-9 col-sm-3" style="margin-left: 77.5%;">  
								                  <button type="button" class="btn btn-primary btn-flat" onclick="javascript: resetActive(div1, event, 0, 'step-1');"><i class="fa fa-chevron-circle-left"></i> Anterior</button>
								                  <button type="button" class="btn btn-primary btn-flat" onclick="javascript: resetActive(div3, event, 70, 'step-3');">Próximo <i class="fa fa-chevron-circle-right"></i></button>
								                </div>
								              </div>
								        </div>
								        <div class="hiddenStepInfo" id="step-3" style="margin-top: 2%;">
								            ...
								            <div class="form-group">
							                  ...
							                  <div class="col-sm-10">
								              	<select class="form-control selectpicker" data-live-search="true" name="escolas" id="comboEscola" onchange="mudarEscola();">
											  		<g:each in="${escolas}">
							                ...
							                <div class="form-group">
							                  <label for="iNumeroMatricula" class="col-sm-2 control-label">Nº Matrícula</label>
								                <div class="col-sm-10">
								                  <g:textField class="form-control" name="matricula" value=""/>
								                </div>
							                </div>
							                <div class="form-group">
							                  <label for="iDataDaMatricula" class="col-sm-2 control-label">Data da matrícula</label>
								                <div class="col-sm-10">
								                  <g:formatDate format="yyyy-MM-dd" date="${date}" />
												  <g:datePicker noSelection="['':'']" precision="day" class="form-control" required="true" name="dataDaMatricula" value=""/>
								                </div>
							                </div>	              							
								            <div class="form-group" style="margin-top: 3%;">
								              <div class="col-sm-offset-9 col-sm-3" style="margin-left: 77.5%;">  
								              	<button type="button" class="btn btn-primary btn-flat" onclick="javascript: resetActive(div2, event, 35, 'step-2');"><i class="fa fa-chevron-circle-left"></i> Anterior</button>
								                <button type="submit" class="btn btn-success btn-flat" onclick="javascript: resetActive(div4, event, 100, 'step-3');">Finalizar <i class="fa fa-check-circle"></i></button>
								              </div>
								            </div>
								        </div>
								    </div>
