				...
				<g:form controller="Professor" action="atualizar" enctype="multipart/form-data"
					...
					<fieldset>
						...
						<div class="box box-white">
							<fieldset>
								<legend class="scheduler-border">Documentos</legend><table id="listarDocumentosAluno" class="table table-bordered">
							...
							<label style="display: block"><input type="button" name="addFile1" value="Novo Documento"></label> <br> <label style="display: block"><input type="file" name="documentos[]" id="documentos[]" enctype="multipart/form-data"> <br> <input type="button" name="limpar" value="Limpar" onclick="limparCampoFile()">
							</label> <br>
